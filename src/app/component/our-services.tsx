...
const OurServices = () => {
  ...
  return (
    ...
    <div className="w-full mt-5  container p-5 md:p-15" id="service">

      <h1 className="text-[#F1F1F1] font-Medium text-[24px] md:text-[42px]  text-center ">Our services</h1>
      ...
      <div className="md:mt-35 mt-10 grid grid-cols-2 md:grid-cols-3 gap-5">
        <div className="card-service grid">
          <img src="./assets/video-making.png" className="w-[152px] mx-auto" alt="" />
        ...
        <div className="card-service grid">
          <img src="./assets/branding.png" className="w-[152px] mx-auto" alt="" />
        ...
        <div className="card-service grid">
          <img src="./assets/Marketingstrategy.png" className="w-[152px] mx-auto" alt="" />
        ...
        <div className="card-service grid">
          <img src="./assets/Email-Marketing.png" className="w-[152px] mx-auto" alt="" />
        ...
        <div className="card-service grid">
          <img src="./assets/SocialMediaManaging.png" className="w-[152px] mx-auto" alt="" />
        ...
        <div className="card-service grid">
          <img src="./assets/ContentWriting.png " className="w-[152px] mx-auto" alt="" />
