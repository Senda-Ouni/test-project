...
const Header = () => {
  ...
  return (
    ...
    <div className="w-full min-h-[100vh] grid grid-cols-1 md:grid-cols-12 p-10 gap-5 container">
      <div className="w-full grid content-between col-span-7 ">
        <div className=" w-[86%] ">

          <h1 className="text-[50px]  text-white font-SemiBold">Transform your business <br /> with our <span className="text-heder-change"> Creative Marketing Solutions!</span></h1>
          <p className="text-[16px] font-Regular text-white mt-5 leading-[26px]">Welcome to Focus Marketing Solutions! We're a creative team dedicated to driving your business forward with innovative marketing
